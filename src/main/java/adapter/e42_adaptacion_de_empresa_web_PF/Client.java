package adapter.e42_adaptacion_de_empresa_web_PF;
...
public class Client {
    public static void main(String[] args) {
        ...
        IAplicacionEmpresa2 desktop = new AplicacionEscritorio("Photo Shop", "1.0.1", "2025-03-10", "504.00 MB.", ".exe", new Usuario("AleS_900", "Alejandro123"));
