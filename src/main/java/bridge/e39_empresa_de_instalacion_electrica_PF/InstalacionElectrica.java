...
public class InstalacionElectrica implements ITipoInstalacion{
    ...
    public InstalacionElectrica(ITipoPago payment_method, String instl_id, String instl_type, String voltage, double price) {
