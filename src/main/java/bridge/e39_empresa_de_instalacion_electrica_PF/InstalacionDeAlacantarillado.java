...
public class InstalacionDeAlacantarillado implements  ITipoInstalacion {
    private ITipoPago payment_method;
    private String instl_id;
    private String instl_type;
    private double price;

    public InstalacionDeAlacantarillado(ITipoPago payment_method, String instl_id, String instl_type, double price) {
    ...
    public void showInfo() {
        ...
        System.out.println("INSTALACION ALCANTARILLADO");
