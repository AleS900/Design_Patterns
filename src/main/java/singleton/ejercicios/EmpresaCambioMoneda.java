...
import singleton.ejercicios.EmpresaCambioMoneda;

public class EmpresaCambioMoneda
{
    private static singleton.ejercicios.EmpresaCambioMoneda instance = null;
    ...
    {
        if (instance == null)
            instance= new singleton.ejercicios.EmpresaCambioMoneda();
    }
